...
**Homepage:** <https://github.com/epmd-edp/javascript-npm-react.git>
...
* <https://github.com/epmd-edp/javascript-npm-react.git>
...
| image.repository | string | `"js-react-npm"` |  |
| image.tag | string | `""` | Overrides the image tag whose default is the chart appVersion. |
| imagePullSecrets[0].name | string | `"regcred"` |  |
| ingress.annotations | object | `{}` |  |
| ingress.dnsWildcard | string | `"gke-sandbox.epmd-edp-anthos.eu.gcp.cloudapp.epam.com"` |  |
